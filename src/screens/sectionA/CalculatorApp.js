    ...
    const handlePress = (input) => {
        switch (input) {
            ...
            case '=':
                ...
                // setDisplay(result % 1 === 0 ? result : result.tofixed(2))           
                break
            case 'CLEAR':
                setDisplay('0')
                break
            case 'DEL':
                ...
                setDisplay(deleteString.length === 0 ? '0' : deleteString)
                // let deleteString=display.slice(0,string.length-1)
                // setFirstValue(deleteString.length == 1 ? '' : deleteString)
        }
    }
